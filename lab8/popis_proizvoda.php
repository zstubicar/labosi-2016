		...
		<div class="row">
				...
				<div class="main_proizvodi">
					...
					<div class="text_proizvodi">
						<div class="filter">
							<input type="search" id="search" class="light-able-filter" data-table="table" placeholder="Filtriraj" onkeyup="loadDoc()" />
							<br><br>
						</div>
						...
						<script>
							function loadDoc() {
							  ...
							  xhttp.open("GET","spajanje.php?upit="+document.getElementById("search").value, true);
							  xhttp.send();
							}
						</script>
